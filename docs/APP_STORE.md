...
Each app should have a narrow App Store promise. Do not describe any first app as a complete atlas or full geography suite.
...
Screenshots should communicate clear gameplay, native quality, and calm learning.
