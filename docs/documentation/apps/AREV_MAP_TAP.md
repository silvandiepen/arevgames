...
- borders hidden or reduced.
- correct/wrong scoring remains simple.

### 4. Practice Misses

Question pool:

- weak countries from local history.
...
Same map engine as Pinpoint, but simpler scoring.

Tiny countries still need:

- zoom.
- tap tolerance.
- target reveal.
- possible special handling in official presets.
