...
Help players identify countries from different clue types.

Every mode answers the same core question: which country is this?
...
- world map with one country highlighted.
...
The round should balance clue types where possible, not accidentally generate all one type unless configured.
